...
void schedule(T function, const std::string& description, const int n)
{
    ...
    double start_time = omp_get_wtime();  // Início da medição
    function(vectors, n);
    double end_time = omp_get_wtime();    // Fim da medição
    double elapsed_time = end_time - start_time;

    print_iterations(description, vectors, n);
    std::cout << "Tempo de execução: " << elapsed_time << " segundos\n\n";
}
...
int main()
{
    ...
    // Teste dos diferentes schedulers
